...
class inferencerClass(Module):
    def __init__(self, jetSelection):
        ...
        self.model4p1_hadhad_ohe = load_model(base + '/src/PhysicsTools/NanoAODTools/data/IN_hadhad_v4p1,on_QCD,fillFactor=2,200GeV,ohe,take_5,model.h5',custom_objects={'tf': tf, 'RK': RK, 'RV': RV, 'RS': RS, 'RR': RR, 'RRT': RRT, 'RKT': RKT})
        self.model6p1_hadel_ohe = load_model(base + '/src/PhysicsTools/NanoAODTools/data/IN_hadel_4p1,on_TTbar_WJets,fillFactor=1_5,200GeV,ohe,take_1,model.h5',custom_objects={'tf': tf, 'RK': RK, 'RV': RV, 'RS': RS, 'RR': RR, 'RRT': RRT, 'RKT': RKT})
        self.model6p1_hadmu_ohe = load_model(base + '/src/PhysicsTools/NanoAODTools/data/IN_hadmu_v4p1,on_TTbar_WJets,fillFactor=1_5,200GeV,ohe,take_1,model.h5',custom_objects={'tf': tf, 'RK': RK, 'RV': RV, 'RS': RS, 'RR': RR, 'RRT': RRT, 'RKT': RKT})
...
#        self.massreg_hadmu.load_weights(base+ '/src/PhysicsTools/NanoAODTools/data/fullmodel_hadmu_regression_v0_weights.h5')
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("IN_hadhad_v4p1_ohe", "F", 1)
        self.out.branch("IN_hadel_v4p1_ohe", "F", 1)
        self.out.branch("IN_hadmu_v4p1_ohe", "F", 1)
